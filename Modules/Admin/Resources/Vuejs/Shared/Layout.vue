...
import Logo from '@admin/Shared/Logo.vue'
import Dropdown from '@admin/Shared/Dropdown.vue'
import MainMenu from '@admin/Shared/MainMenu.vue'
import FlashMessages from '@admin/Shared/FlashMessages.vue'
