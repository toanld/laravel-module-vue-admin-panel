...
class PermissionController extends Controller
{
    ...
    public function index()
    {
        ...
        return Inertia::module('admin::Admin/Permission/Index', [
    ...
    {
        return Inertia::module('admin::Admin/Permission/Create');
    }
    ...
    {
        return Inertia::module('admin::Admin/Permission/Show', [
