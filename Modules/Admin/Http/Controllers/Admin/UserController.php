...
class UserController extends Controller
{
    ...
    public function index()
    {
        ...
        return Inertia::module('admin::Admin/User/Index', [
            'users' => $users,
    ...
    public function create()
    {
        ...
        return Inertia::module('admin::Admin/User/Create', [
            'roles' => $roles,
        ]);
    }
    ...
    public function show(User $user)
    {
        ...
        return Inertia::module('admin::Admin/User/Show', [
            'user' => $user,
            'roles' => $roles,
    ...
    public function edit(User $user)
    {
        $roles = Role::all()->pluck("name","id");
        $userHasRoles = array_column(json_decode($user->roles, true), 'id');
        return Inertia::module('admin::Admin/User/Edit', [
            'user' => $user,
            'roles' => $roles,
            'userHasRoles' => $userHasRoles,
        ]);
    ...
    {
        $user = \Auth::user();
        return Inertia::module('admin::Admin/User/Accountinfo', [
            'user' => $user,
        ]);
    }
