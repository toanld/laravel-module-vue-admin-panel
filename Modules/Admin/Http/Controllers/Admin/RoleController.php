...
class RoleController extends Controller
{
    ...
    public function index()
    {
        ...
        return Inertia::module('admin::Admin/Role/Index', [
            'roles' => $roles,
    ...
    public function create()
    {
        ...
        return Inertia::module('admin::Admin/Role/Create', [
    ...
    public function show(Role $role)
    {
        ...
        return Inertia::module('admin::Admin/Role/Show', [
            'role' => $role,
            'permissions' => $permissions,
    ...
    public function edit(Role $role)
    {
        ...
        return Inertia::module('admin::Admin/Role/Edit', [
            'role' => $role,
            'permissions' => $permissions,
            'roleHasPermissions' => $roleHasPermissions,
        ]);
