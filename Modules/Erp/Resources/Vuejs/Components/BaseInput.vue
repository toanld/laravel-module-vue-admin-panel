...
<template>
    <div class="relative py-2" :class="[mb]">
        <input type="text" v-model="inputValue" :name="name" id="floating_outlined" class="block px-2.5 placeholder:opacity-0 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent bg-white rounded-lg border-2 border-gray-300 appearance-none dark:text-white dark:border-main dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-main peer focus:placeholder:opacity-100" :autocomplete="autocomplete" :placeholder="placeholder" />
